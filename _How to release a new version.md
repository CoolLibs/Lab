- Remove the "WIP" in the version number in *src/Dump/coollab_version.cpp* and commit with the message "🔖 [beta-1] Release" (make sure to replace with the right version number)
