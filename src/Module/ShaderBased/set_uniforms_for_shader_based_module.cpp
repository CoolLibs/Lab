...
{
    shader.bind();
    shader.set_uniform("_camera2D", system_values.camera2D);
    shader.set_uniform("_camera2D_inverse", glm::inverse(system_values.camera2D));
    shader.set_uniform("_height", system_values.height);
    shader.set_uniform("_aspect_ratio", system_values.render_target_aspect_ratio);
    shader.set_uniform("_inverse_aspect_ratio", 1.f / system_values.render_target_aspect_ratio);
    ...
    Cool::CameraShaderU::set_uniform(shader, system_values.camera3D, system_values.render_target_aspect_ratio);
