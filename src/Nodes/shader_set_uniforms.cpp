...
auto shader_set_uniforms(Cool::OpenGL::Shader const& shader, Module::RenderParams const& in, ModuleShaderDependencyFlags const& dependencies) -> void
{
    shader.bind();
    ...
    shader.set_uniform_texture(
        ...
        dependencies.feedback_double_buffer.read_target().get().texture_id(),
