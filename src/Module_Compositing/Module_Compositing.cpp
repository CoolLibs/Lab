...
void Module_Compositing::compile(UpdateContext_Ref update_ctx, bool for_testing_nodes)
{
...
auto Module_Compositing::nodes_config(Ui_Ref ui, Cool::NodesLibrary& nodes_library) const -> NodesConfig
{
    return NodesConfig{
        ui.input_factory(),
...
void Module_Compositing::submit_gizmos(Cool::GizmoManager& gizmos, UpdateContext_Ref ctx)
{
...
auto Module_Compositing::all_inputs() const -> Cool::AllInputRefsToConst
{
...
void Module_Compositing::debug_show_nodes_and_links_registries_windows(Ui_Ref ui) const
{
