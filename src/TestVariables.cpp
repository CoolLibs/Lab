...
void test_variables()
{
    ...
    static Cool::Variable<Cool::Hue>          hue{"Hue", Cool::Hue(0.5)};
    static Cool::Variable<Cool::RgbColor>     color{"Color", Cool::RgbColor{glm::vec3{0.f, 1.f, 0.5f}}};
    static Cool::Variable<Cool::Direction2D>  direction{"Direction", Cool::Direction2D(glm::vec2(0., 10.))};
