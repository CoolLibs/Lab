...
public:
    ...
    virtual auto to_string() const -> std::string                                                    = 0; // TODO have a to_string_forward and to_string_backward (NB: find better names) to convert to string the execution and the revert of the command
