...
public:
    ...
    virtual void revert(CommandExecutionContext_Ref const&) const                                    = 0;
    ...
    virtual auto merge(IReversibleCommand const& previous) const -> std::optional<ReversibleCommand> = 0;
};
