...
struct SystemValues {
    ...
    auto aspect_ratio() const -> float { return img::aspect_ratio(render_target_size); }
    auto inverse_aspect_ratio() const -> float { return img::inverse_aspect_ratio(render_target_size); }
