...
private:
    ...
    auto input_provider                             (float render_target_aspect_ratio,float height, float time, glm::mat3 const& cam2D) { return Cool::ValueProvider{_project.variable_registries, render_target_aspect_ratio, height, time, cam2D}; }
