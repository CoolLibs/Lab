...
#include "NodesGraph/NodesGraph.h"
...
struct Project {
    ...
    History                        history{};
    std::unique_ptr<NodesGraph>    nodes_graph; // TODO(Particles) Can't we avoid the unique_ptr?
...
private:
    ...
    void serialize(Archive& archive)
    {
        ...
        archive(
            ...
            cereal::make_nvp("Nodes Graph", nodes_graph),
