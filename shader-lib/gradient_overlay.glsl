vec3 gradient_overlay(
    ...
    vec2 gradient_pos_a, vec2 gradient_pos_b, vec3 gradient_color_a, vec3 gradient_color_b, float gradient_presence, bool use_the_best_blending_technique
)
{
    vec2 uv = _uv;
    uv.x *= _aspect_ratio;
    ...
    vec3  color          = use_the_best_blending_technique
